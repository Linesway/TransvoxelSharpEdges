/**
 * Transvoxel regular-cell polygon table in extended format:
 *   [n_components, nv_0, idx..., nv_1, idx..., ...]
 * generated from regularCellData triangle topology (same idea as gen_regular_polygon_table.cpp).
 *
 * Note: components are closed cycles and therefore usually repeat the first
 * vertex as the last index (e.g. triangle -> [0,1,2,0]).
 */
import { regularCellClass, regularCellData } from './transvoxel-regular-tables.js';
...
export const regularCellPolyTable = buildTable();
