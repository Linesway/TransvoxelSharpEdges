 ...
 * - regularCellPolyTable[256][32]: [n_components, nv_0, idx..., nv_1, ...], -1 padded to 32.
...
/** regularCellPolyTable[caseIndex][0..31]. Layout: n_components, then per component (nv, v0, v1, ...), -1 padded. */
