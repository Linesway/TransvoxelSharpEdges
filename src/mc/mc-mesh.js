/**
 * Build a PlayCanvas mesh from marching cubes output (classic or extended).
...
export function createMeshFromMCResult(device, mcResult, options = {}) {
  ...
  if (nV === 0 || mcIndices.length === 0) {
    console.warn('createMeshFromMCResult: no vertices or indices');
    return null;
  }
